pipeline {
  ...
  post {
     success {
		...
		rocketSend(
    			attachments: [[color: 'green', text: 'Build Succes'', title: 'my attachment'],['MessageAttachment', color: 'red', text: 'Something failed', title: 'my other attachment'],],channel: 'sa-project', message: 'My message', rawMessage: true)
	}
     failure {
